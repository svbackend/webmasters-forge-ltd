 ...
 * echo Html::img(ImageResizeHelper::init()->image('uploads/pic.jpg')->fitWidth(500));
...
class Thumbnail
{
    ...
    public static function getThumb($file, $width, $height)
    {
        return self::init()->image($file)->crop($width, $height);
    }
    ...
    {
        $this->_siteRoot = Url::toPath();
        $this->_cachePath = Url::toPath('files/cache');
        $this->_cacheUrl = Url::to('files/cache');
        $this->_quality = 85;
        $this->_defaultImage = Url::toPath('files/avatars/default.png');
